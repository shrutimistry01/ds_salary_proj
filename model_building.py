...
df_model= df[['avg_sal','Rating','Size','Location', 'Founded', 'Type of ownership','Industry', 'Sector', 'Revenue', 'per hour', 'per month',
              'company_age','python', 'R', 'spark','machine_learning', 'AI', 'hadoop', 'sql', 'title', 'seniority', 'desc_len']]
#get dummy data
